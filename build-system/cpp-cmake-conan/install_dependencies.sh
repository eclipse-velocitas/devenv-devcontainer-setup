...
BUILDDIR="${VELOCITAS_WORKSPACE_DIR}/build"
...
conan install -pr:h ${SCRIPTPATH}/.conan/profiles/linux_${BUILD_ARCH}_${BUILD_VARIANT} --build "${WHICH_DEPS_TO_BUILD}" ${VELOCITAS_WORKSPACE_DIR}
